<template>
  <el-dialog v-model="dialogVisible" title="除险加固" width="1200" append-to-body>
    ...
    <div class="table_box">
      <el-table :data="tableData" style="width: 100%" :height="500" size="large" stripe>
        ...
        <el-table-column prop="status_str" label="安全管理状态" align="center"></el-table-column>
        <el-table-column label="工程检查" align="center">
          <el-table-column prop="wtNum" label="发现问题" align="center"></el-table-column>
          <el-table-column prop="czzNum" label="处置中" align="center"></el-table-column>
          <el-table-column prop="yzgNum" label="已整改" align="center"></el-table-column>
        </el-table-column>
      </el-table>
    </div>
  </el-dialog>
