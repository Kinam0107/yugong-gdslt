<template>
  <el-dialog v-model="dialogVisible" title="问题处置" width="1200" append-to-body>
    ...
    <div class="table_box">
      <el-table :data="tableData" style="width: 100%" :height="500" size="large" stripe>
        ...
        <el-table-column prop="CHECKMAIN" label="检查类型" align="center"></el-table-column>
        <el-table-column prop="ctype" label="检查主体" align="center"></el-table-column>
        <el-table-column prop="tm" label="发生时间" align="center"></el-table-column>
        <el-table-column prop="pname" label="问题描述" align="center"></el-table-column>
        <el-table-column prop="lev" label="问题级别" align="center"></el-table-column>
        <el-table-column prop="type" label="整改进展" align="center"></el-table-column>
      </el-table>
    </div>
  </el-dialog>
</template>
